...
OPPS AS (
    ...
    SELECT v.ACCOUNT_ID OPP_ACCOUNT_ID,
           ...
           CASE 
             WHEN v.ACCOUNT_SEGMENT = 'Self-Service' THEN 'SMB'
             ELSE v.ACCOUNT_SEGMENT END as OPP_ACCOUNT_SEGMENT,
...
SELECT OPP_ACCOUNT_SEGMENT, FQ, count(distinct(CREATED_OPPS))
FROM OPPS
GROUP BY 1,2
ORDER BY 2,1
