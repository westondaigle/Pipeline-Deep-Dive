-------BDA and AE's active per quarter
...
SELECT OWNER_NAME, OWNER_ROLE, ACTIVITY_ACCOUNT_SEGMENT, FISCAL_YEAR, FISCAL_QUARTER, COUNT(OWNER_NAME)
FROM ACTIVITY_TABLE
WHERE OWNER_ROLE = 'Account Executive' OR OWNER_ROLE = 'BDA'
GROUP BY 1,2,3,4,5
ORDER BY 1, 4,5
